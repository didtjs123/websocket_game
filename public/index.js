...
// 게임 데이터 관리
let gameData = {
  stagesData: null, // 스테이지 데이터
  itemsData: null, // 아이템 데이터
  itemUnlockData: null, // 아이템 잠금 해제 데이터
  currentStageId: 1000, // 초기 스테이지 ID
};

// 데이터 로드
async function loadGameData() {
  const data = await loadData(); // 서버에서 데이터 로드
  gameData.stagesData = data.stages.data;
  gameData.itemsData = data.items.data;
  gameData.itemUnlockData = data.itemUnlocks.data;
